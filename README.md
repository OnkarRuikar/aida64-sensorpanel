...
2. After installing the software, [Enable and show sensor panel](https://www.aida64.com/user-manual/sensorpanel/designing-new-panel?language_content_entity=en#to-show-the-default-sensorpanel-and-start-designing). Use the following settings in "Preferences" window, and click "Apply":
...
4. Download the [1280x400.spzip](1280x400.spzip) file and import it using the "Import" button on the top right corner of the SensorPanel manager.
...
You can refer to the [Ultimate Sensor Panel Guide](https://www.youtube.com/watch?v=nIhv-_c-Pas) on YouTube for the setup and customizations.
...
For any query, feel free to open a [GitHub issue](https://github.com/OnkarRuikar/aida64-sensorpanel/issues)
